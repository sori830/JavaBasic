...
public class WrapperEx {
    public static void main(String[] args) {
        ...
        char c1 = '4', c2 = 'F';
        if(Character.isDigit(c1)) // 문자 c1이 숫자 -> true
            System.out.println(c1 + "는 숫자");
        if(Character.isAlphabetic(c2)) // 문자 c2가 영문자 -> true
        ...
        System.out.println(Integer.bitCount(28)); // 정수 28의 이진수 표현에서 1의 개수
        ...
        System.out.println(Boolean.parseBoolean("false")); // 문자열 "false"를 불린값 false로 변환
    }
}
